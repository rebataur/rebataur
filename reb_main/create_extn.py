...
class CreateExtn:
	...
	def init_twitter_extn(self):
		...
		twitter_sql = extn_cons.twitter_fdw_sql % (access_token, access_token_secret,consumer_key,consumer_secret)
	...
	def init_aws_pg_extn(self):
		...
		aws_pg = extn_cons.aws_pg_fdw_sql % ( aws_pg_host,aws_pg_db,aws_pg_port,aws_pg_user,aws_pg_pwd)
